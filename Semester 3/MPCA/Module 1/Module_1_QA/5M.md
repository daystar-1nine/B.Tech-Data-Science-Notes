...
$$	ext{CPU Time} = rac{	ext{Instruction Count} 	imes 	ext{CPI}}{	ext{Clock Rate (f)}}$$
...
$$	ext{MIPS} = rac{	ext{Instruction Count}}{	ext{Execution Time} 	imes 10^6} = rac{	ext{Clock Rate}}{	ext{CPI} 	imes 10^6}$$
