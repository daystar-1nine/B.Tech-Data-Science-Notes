...
| :--- | :--- | :--- |
| **Selection** | $\sigma$ | Extracts specific **rows** satisfying a condition |
| **Projection** | $\pi$ | Extracts specific **columns**, discarding others |
...
| **Join** | $\bowtie$ | Combines related tuples from two relations (Cartesian × Selection) |
